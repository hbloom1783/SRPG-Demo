...
namespace SRPGDemo.Strategic.Gameplay
{
    ...
    {
        void HexTouchedHandler(FlatHexPoint? loc);
    ...
    public abstract class GameControllerState : IStateMachineState, IInputHandler
    {
        ...
        public abstract void HexTouchedHandler(FlatHexPoint? loc);
    ...
    [AddComponentMenu("SRPG Demo/Strategic/Gameplay Controller")]
    [RequireComponent(typeof(AudioSource))]
    public class GameController : StateMachineMonoBehaviour<GameControllerState>
    {
        public MapPiece mapPiecePrefab;
        ...
        public FlatHexPoint? mouseLoc = null;
        ...
        private void UpdateInput()
        {
            ...
            FlatHexPoint? newMouseLoc = map.MousePosition;
